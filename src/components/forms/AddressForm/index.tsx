  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-col gap-4 mb-8">
        ...
        <FormItem>
          <Label htmlFor="addressLine1">Адрес (строка 1)*</Label>
          <Input
            id="addressLine1"
            autoComplete="address-line1"
            {...register('addressLine1', { required: 'Адрес обязателен.' })}
          />
          {errors.addressLine1 && <FormError message={errors.addressLine1.message} />}
        </FormItem>

        <FormItem>
          <Label htmlFor="addressLine2">Адрес (строка 2)</Label>
        ...
        <FormItem>
          ...
          <Input
            id="postalCode"
            {...register('postalCode', { required: 'Почтовый индекс обязателен.' })}
          />
